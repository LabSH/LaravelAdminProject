...
<form name="form1" action="">
	...
	<table class="table table-sm table-bordered table-hover mymargin5">
		<tr class="mycolor2">
			...
			<td width="25%">제품명</td>
			<td width="10%">단가</td>
			<td width="10%" style='background-color:lightyellow'>매입수량</td>
			<td width="10%" style='background-color:lightyellow'>매출수량</td>
			<td width="15%">금액</td>
			<td width="15%">비고</td>
	...
	<tr>
		...
		<td align = "right" style='background-color:lightyellow'>{{number_format($row->numi)}}</td>
		<td align = "right" style='background-color:lightyellow'>{{number_format($row->numo)}}</td>
